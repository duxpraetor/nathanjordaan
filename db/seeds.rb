...
cv = Cv.find_or_create_by!(user: user) do |c|
  ...
  c.summary = "Full-stack developer with a decade of experience across logistics, mining and fintech. I design, develop and deploy mobile, web, and data systems end-to-end."
  c.github_url = "https://github.com/duxpraetor/nathanjordaan"
  c.website_url = "https://nathanjordaan.com"
end

# Create tags
tag_names = [ "SQL", "Ruby on Rails", "C#", ".NET", "Angular", "React", "React Native", "Docker", "Git", "Scrum", "Razor", "OSIsoft", "Sage", "Azure IoT", "Azure Data Explorer", "Azure DevOps", "MSSQL", "Expo", "Java", "Drools", "Process Design", "LLMs" ]
tags = tag_names.index_with { |name| Tag.find_or_create_by!(name: name) }

# Tag the CV
cv.tags = [ tags["SQL"], tags["Ruby on Rails"], tags["C#"], tags[".NET"], tags["Angular"], tags["React"], tags["React Native"], tags["Docker"], tags["Git"], tags["Scrum"], tags["LLMs"] ]
...
shipshape = work.entries.find_or_create_by!(title: "ShipShape Software", display_order: 1) do |e|
  e.date_text = "2021 to 2026"
  e.meta = "SaaS · ERP · Logistics"
...
am2 = work.entries.find_or_create_by!(title: "AM² Systems", display_order: 2) do |e|
  ...
  e.meta = "Startup · Mining · Petrochem"
